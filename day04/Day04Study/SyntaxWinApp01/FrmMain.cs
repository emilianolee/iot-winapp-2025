...
namespace SyntaxWinApp01
{
    public partial class FrmMain : Form
    {
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            // 큰 사이즈의 데이터형에 작은 사이즈 데이터형 값 할당(묵시적 형 변환)
            //person.Age = NudAge.Value;
            person.Age = Convert.ToInt32(NudAge.Value);     // 이 방식을 더 선호
            ...
            catch (ArithmeticException ex)  // DevideByZeroException의 부모클래스를 사용해도 무방
            {
