namespace SyntaxWinApp01
{
    ...
    internal class Person
    {
        ...
        public string Name { get; set; }    // getName, setName 을 자동 생성
        ...
        public int BirthYear { get; set; }      // 출생년도

        // Python 클래스__str__() 와 동일
        ...
        public void Getup()
        {
            MessageBox.Show($"{Name}(이)가 아침에 일어납니다.");
        }

        public void GoToSchool()
        {
            MessageBox.Show($"{Name}(이)가 학교에 갑니다.");
        }
