namespace SyntaxWinApp01
{
    public partial class FrmMain : Form
    {
        ...
        private void BtnMsg_Click(object sender, EventArgs e)
        {
            ...
            ushort ustVal = 65535;  // unsigned short : 0 ~ 66535 저장(2 bytes 크기)
            System.UInt16 ustVal2 = System.UInt16.MinValue;    // 0 할당
            int intVal = 2147483647; // int : -21억 ~ 21억 (4 byte 크기)
            ...
            System.Int128 bigLongVal03; //(16 bytes)

            // 실수 자료형
            float fVal = 3.1515292f;    // float : 4 bytes 소수점
            ...
            // Nullable
            //int int02 = null;   // 기본타입(정수형, 실수형, 불린 / 단 문자열 제외)은 NULL 할당 불가
