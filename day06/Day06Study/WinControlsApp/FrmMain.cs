...
namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            toolTip1.SetToolTip(TxtYear, "달력 선택 연도 표시 텍스트 박스입니다.");
        }
        ...
        private void ChangeFont()
        {
            ...
            FontStyle style = FontStyle.Regular;    // 0대신에 Regular 사용
        ...
        private void BtnModal_Click(object sender, EventArgs e)
        {
            ...
            frmModal.StartPosition = FormStartPosition.CenterParent;    // 부모위치의 정중앙
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            frmModaless.BackColor = Color.SkyBlue;
            // 모달리스창을 모달창처럼 메인창 정중앙에 위치시키려면 계산
        ...
        private void BtnOpenImage_Click(object sender, EventArgs e)
        {
            ...
            if (DlgOpenImage.ShowDialog() == DialogResult.OK)
            {
                ...
                // PictureBoxSizeMode.StretchImage 이미지가 넓이, 높이를 픽처박스크기에 맞춰서 이미지가 얼그러짐
            }
        }
